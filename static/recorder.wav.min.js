...
!function (h) {
    ...
    A.IsOpen = function () {
        ...
        for (var e in F("Recorder Destroy"), g(), n) n[e]()
    };
    var n = {};
    ...
    var S = function (e) {
        var t = (e = e || A).BufferSize || A.BufferSize, n = A.Ctx, r = e.Stream,
            a = r._m = n.createMediaStreamSource(r),
            o = r._p = (n.createScriptProcessor || n.createJavaScriptNode).call(n, t, 1, 1);
        a.connect(o), o.connect(n.destination);
        var f = r._call;
        o.onaudioprocess = function (e) {
            for (var t in f) {
                for (var n = e.inputBuffer.getChannelData(0), r = n.length, a = new Int16Array(r), o = 0, s = 0; s < r; s++) {
                    var i = Math.max(-1, Math.min(1, n[s]));
                    i = i < 0 ? 32768 * i : 32767 * i, a[s] = i, o += Math.abs(i)
                }
        ...
        if (n && (n._m && (n._m.disconnect(), n._p.disconnect(), n._p.onaudioprocess = n._p = n._m = null), t)) {
    ...
    A.SampleData = function (e, t, n, r, a) {
        ...
        for (var v = new Int16Array(f), p = 0, u = 0; u < i.length; u++) v[p] = i[u], p++;
        for (var m = e.length; o < m; o++) {
            for (var h = e[o], u = s, d = h.length; u < d;) {
                var S = Math.floor(u), g = Math.ceil(u), _ = u - S, y = h[S],
                    I = g < d ? h[g] : (e[o + 1] || [y])[0] || 0;
                v[p] = y + (I - y) * _, p++, u += l
            }
            s = u - d
        }
        ...
        if (0 < M) {
            var x = 2 * (v.length - M);
            i = new Int16Array(v.buffer.slice(x)), v = new Int16Array(v.buffer.slice(0, x))
        }
        return {index: o, offset: s, frameNext: i, sampleRate: n, data: v}
    ...
    var F = function (e, t) {
        var n = new Date,
            ...
            a = ["[" + r + " Recorder]" + e], o = arguments, s = 2, i = console.log;
        for ("number" == typeof t ? i = 1 == t ? console.error : 3 == t ? console.warn : i : s = 1; s < o.length; s++) a.push(o[s]);
        i.apply(console, a)
    };
    A.CLog = F;
    var r = 0;
    ...
    function t(e) {
        ...
        var t = {type: "mp3", bitRate: 16, sampleRate: 16e3, onProcess: d};
    ...
    A.Sync = {O: 9, C: 9}, A.prototype = t.prototype = {
        _streamStore: function () {
            ...
            var a = function (e, t) {
                ...
                F("open成功"), e(), t._SO = 0
            }, s = r.Sync, i = ++s.O, c = s.C;
            t._O = t._O_ = i, t._SO = t._S;
            var f = function () {
                if (c != s.C || !t._O) {
                    var e = "open被取消";
                    return i == s.O ? t.close() : e = "open被中断", a(e), !0
                }
            }, u = t.envCheck({envName: "H5", canProcess: !0});
            if (u) a("不能录音：" + u); else if (t.set.sourceStream) {
                if (!A.Support()) return void a("不支持此浏览器从流中获取录音");
                g(r), t.Stream = t.set.sourceStream, t.Stream._call = {};
                try {
                    S(r)
                } catch (e) {
                ...
                var l = function (e, t) {
                    ...
                    /Permission|Allow/i.test(e) ? a("用户拒绝了录音权限", !0) : !1 === h.isSecureContext ? a("无权录音(需https)") : /Found/i.test(e) ? a(t + "，无可用麦克风") : a(t)
                };
                if (A.IsOpen()) o(); else if (A.Support()) {
                    var v = function (e) {
                        (A.Stream = e)._call = {}, f() || setTimeout(function () {
                            f() || (A.IsOpen() ? (S(), o()) : a("录音功能无效：无音频流"))
                        }, 100)
                    }, p = function (e) {
                        var t = e.name || e.message || e.code + ":" + e;
                        F("请求录音权限错误", 1, e), l(t, "无法录音：" + t)
                    }, m = A.Scope.getUserMedia({audio: t.set.audioTrackSet || !0}, v, p);
                    m && m.then && m.then(v)[e && "catch"](p)
                } else l("", "此浏览器不支持录音")
            }
        }, close: function (e) {
            e = e || d;
            var t = this._streamStore();
            this._stop();
            var n = t.Sync;
            if (this._O = 0, this._O_ != n.O) return F("close被忽略", 3), void e();
            n.C++, g(t), F("close"), e()
        }, mock: function (e, t) {
            var n = this;
            ...
            for (var h = v, d = 0, S = 0; S < m.length; S++) {
                var g = m[S];
                if (3e3 < v - g.t) {
                    m.length = S;
                    break
            ...
            var k = a.recSize, C = r, w = k + C;
            if (a.recSize = w, s) {
                var R = A.SampleData(c, n, o.sampleRate, s.chunkInfo);
                s.chunkInfo = R, w = (k = s.pcmSize) + (C = R.data.length), s.pcmSize = w, c = s.pcmDatas, f = c.length, c.push(R.data), n = R.sampleRate
            }
            var b = Math.round(w / n * 1e3), T = c.length, z = u.length, D = function () {
                for (var e = O ? 0 : -C, t = null == c[0], n = f; n < T; n++) {
                    var r = c[n];
                    null == r ? t = 1 : (e += r.length, s && r.length && a[o.type + "_encode"](s, r))
                }
                if (t && s) for (n = l, u[0] && (n = 0); n < z; n++) u[n] = null;
                t && (e = O ? C : 0, c[0] = null), s ? s.pcmSize += e : a.recSize += e
            }, O = o.onProcess(c, i, b, n, f, D);
            if (!0 === O) {
                var U = 0;
                for (S = f; S < T; S++) null == c[S] ? U = 1 : c[S] = new Int16Array(0);
                U ? F("未进入异步前不能清除buffers", 3) : s ? s.pcmSize -= C : a.recSize -= C
            } else D()
        }, start: function () {
            var e = this, t = A.Ctx, n = 1;
            if (e.set.sourceStream ? e.Stream || (n = 0) : A.IsOpen() || (n = 0), n) if (F("开始录音"), e._stop(), e.state = 0, e.envStart(null, t.sampleRate), e._SO && e._SO + 1 != e._S) F("start被中断", 3); else {
                e._SO = 0;
                var r = function () {
                    e.state = 1, e.resume()
                };
            ...
            this.state && (this.state = 2, F("pause"), delete this._streamStore().Stream._call[this.id])
        }, resume: function () {
            var n = this;
            n.state && (n.state = 1, F("resume"), n.envResume(), n._streamStore().Stream._call[n.id] = function (e, t) {
            ...
            var s = function () {
                ...
                F("结束录音失败：" + e, 1), t && t(e), s()
            }, c = function (e, t) {
                if (F("结束录音 编码" + (Date.now() - r) + "ms 音频" + t + "ms/" + e.size + "b"), o.takeoffEncodeChunk) F("启用takeoffEncodeChunk后stop返回的blob长度为0不提供音频数据", 3); else if (e.size < Math.max(100, t / 2)) return void i("生成的" + o.type + "无效");
                n && n(e, t), s()
            };
            if (!a.isMock) {
                if (!a.state) return void i("未开始录音");
                a._stop(!0)
            }
            var f = a.recSize;
    ...
    }, h.Recorder && h.Recorder.Destroy(), (h.Recorder = A).LM = "2021-08-03 20:01:03", A.TrafficImgUrl = "//ia.51.la/go1?id=20469973&pvFlag=1", A.Traffic = function () {
    ...
    Recorder.prototype.enc_wav = {
    ...
    }, Recorder.prototype.wav = function (e, t, n) {
        var r = this.set, a = e.length, o = r.sampleRate, s = 8 == r.bitRate ? 8 : 16, i = a * (s / 8),
            c = new ArrayBuffer(44 + i), f = new DataView(c), u = 0, l = function (e) {
        ...
        if (l("RIFF"), p(36 + i), l("WAVE"), l("fmt "), p(16), v(1), v(1), p(o), p(o * (s / 8)), v(s / 8), v(s), l("data"), p(i), 8 == s) for (var m = 0; m < a; m++, u++) {
            var h = 128 + (e[m] >> 8);
            f.setInt8(u, h, !0)
